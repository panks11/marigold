"""Client-side helper class for communicating with the Marigold gateway server."""
import json
...
from marigold.utils import ascii_to_pil, pil_to_ascii


class ConnectionClient:
    """Client-side helper class for communicating with the Marigold deployment server."""
