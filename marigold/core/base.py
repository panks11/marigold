"""MarigoldBase class. Provides unified configuration, logging and context management."""
import logging
...
class MarigoldBase:
    """Base class for all Marigold core classes.

    The MarigoldBase class adds default context manager and logging methods. All classes that derive from
    MarigoldBase can be used as context managers and will use a unified logging format.
    """
