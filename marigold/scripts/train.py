"""Main marigold training script. Saves models to the model registry when finished."""
import logging
import os
import time
...
from marigold import Config as PackageConfig
from marigold.models import LightningModel
from marigold.utils import default_logger, experiment_id, ifnone
